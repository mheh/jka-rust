// trmodel-oracle stub for codemp/qcommon/exe_headers.h
//
...
#ifndef TRMODEL_ORACLE_EXE_HEADERS_H
#define TRMODEL_ORACLE_EXE_HEADERS_H

#include "../game/q_shared.h"
#include "qcommon.h"

#endif // TRMODEL_ORACLE_EXE_HEADERS_H
