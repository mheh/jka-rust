...
/// MP game engine-to-module syscall callback placeholder.
///
/// TODO: Replace with the typed MP game syscall callback ABI once the entry
/// symbols are wired to the generated ABI surfaces.
pub type EngineSyscall = *const c_void;

/// Raven/OpenJK MP game `dllEntry` export.
#[no_mangle]
pub extern "C" fn dllEntry(_syscall: EngineSyscall) {}

/// Raven/OpenJK MP game `vmMain` export.
#[no_mangle]
...
/// OpenJK MP game table ABI export.
#[no_mangle]
