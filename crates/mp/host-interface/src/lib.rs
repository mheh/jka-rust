...
//!   read/free/write, print/error, `VM_Call`, the shared-memory window,
//!   `flrand`/`irand`, `gentity`, integer cvar reads, `svs.time`, and the
//!   loader model-memory accessors (rulings 24 + 36). Per
