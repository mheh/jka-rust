...
///
/// Source (enum): `oracle/codemp/game/g_public.h:777`
/// Source (args): `oracle/codemp/game/g_main.c:598`
/// Source (output): `oracle/codemp/game/g_main.c:601`
/// Source (call site): `oracle/codemp/icarus/Q3_Interface.cpp:846`
...
impl DecodeVmMain for GameIcarusLerp2Start {
    ...
    // Source: `oracle/codemp/game/g_main.c:598`.
...
impl EncodeVmMainReturn for GameIcarusLerp2Start {
    fn encode_return(_output: Self::Output) -> isize {
        // `... return 0;` — Source: `oracle/codemp/game/g_main.c:601`.
        0
    }
}
