...
///
/// Source (enum): `oracle/codemp/game/g_public.h:783`
/// Source (args): `oracle/codemp/game/g_main.c:634`
/// Source (output): `oracle/codemp/game/g_main.c:637`
/// Source (call site): `oracle/codemp/icarus/Q3_Interface.cpp:912`
...
impl DecodeVmMain for GameIcarusGetfloat {
    ...
    // Source: `oracle/codemp/game/g_main.c:634`.
...
impl EncodeVmMainReturn for GameIcarusGetfloat {
    fn encode_return(output: Self::Output) -> isize {
        // Returns the handler result. Source: `oracle/codemp/game/g_main.c:637`.
        output as isize
    }
}
