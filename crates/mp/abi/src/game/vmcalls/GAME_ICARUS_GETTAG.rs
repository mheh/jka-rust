...
///
/// Source (enum): `oracle/codemp/game/g_public.h:776`
/// Source (args): `oracle/codemp/game/g_main.c:593`
/// Source (output): `oracle/codemp/game/g_main.c:596`
/// Source (call site): `oracle/codemp/icarus/Q3_Interface.cpp:833`
...
impl DecodeVmMain for GameIcarusGettag {
    ...
    // Source: `oracle/codemp/game/g_main.c:593`.
...
impl EncodeVmMainReturn for GameIcarusGettag {
    fn encode_return(output: Self::Output) -> isize {
        // Returns the handler result. Source: `oracle/codemp/game/g_main.c:596`.
        output as isize
    }
}
