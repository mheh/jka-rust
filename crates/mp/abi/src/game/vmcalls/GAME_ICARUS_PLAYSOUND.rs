...
///
/// Source (enum): `oracle/codemp/game/g_public.h:771`
/// Source (args): `oracle/codemp/game/g_main.c:558`
/// Source (output): `oracle/codemp/game/g_main.c:560`
/// Source (call site): `oracle/codemp/icarus/Q3_Interface.cpp:322`
...
impl DecodeVmMain for GameIcarusPlaysound {
    ...
    // Source: `oracle/codemp/game/g_main.c:558`.
...
impl EncodeVmMainReturn for GameIcarusPlaysound {
    fn encode_return(output: Self::Output) -> isize {
        // Returns the handler result. Source: `oracle/codemp/game/g_main.c:560`.
        output as isize
    }
}
