...
///
/// Source (enum): `oracle/codemp/game/g_public.h:781`
/// Source (args): `oracle/codemp/game/g_main.c:622`
/// Source (output): `oracle/codemp/game/g_main.c:625`
/// Source (call site): `oracle/codemp/icarus/Q3_Interface.cpp:887`
...
impl DecodeVmMain for GameIcarusRemove {
    ...
    // Source: `oracle/codemp/game/g_main.c:622`.
...
impl EncodeVmMainReturn for GameIcarusRemove {
    fn encode_return(_output: Self::Output) -> isize {
        // `... return 0;` — Source: `oracle/codemp/game/g_main.c:625`.
        0
    }
}
