...
/// `CG_SHUTDOWN` MP cgame exports vmMain ABI token.
///
/// Raven: void (*CG_Shutdown)( void );
/// Raven: opportunity to flush and close any open files
/// Enum value source: `oracle/codemp/cgame/cg_public.h:362-364`
/// Args source: `oracle/codemp/cgame/cg_main.c:196-198`
/// Output source: `oracle/codemp/cgame/cg_main.c:196-198`
/// Transport/call-site source: `oracle/codemp/client/cl_cgame.cpp:595-602`
