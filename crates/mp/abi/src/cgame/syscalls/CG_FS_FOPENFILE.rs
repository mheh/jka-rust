...
use mp_qshared::shared::fsMode_t;
...
///
/// Args source: `oracle/oracle/codemp/cgame/cg_syscalls.c:83-84`
/// Transport/switch source: `oracle/oracle/codemp/client/cl_cgame.cpp:737-738`
#[derive(Debug)]
...
/// `CG_FS_FOPENFILE` MP cgame imports syscall ABI token.
///
...
///
/// Enum value source: `oracle/oracle/codemp/cgame/cg_public.h:73`
/// Args source: `oracle/oracle/codemp/cgame/cg_syscalls.c:83-84`
/// Output source: `oracle/oracle/codemp/client/cl_cgame.cpp:737-738`
/// Transport/switch source: `oracle/oracle/codemp/client/cl_cgame.cpp:737-738`
...
impl OutboundSysCall for CgFsFopenfile {
    ...
    const IMPORT: MpCgameImport = MpCgameImport::CG_FS_FOPENFILE;
}
