...
/// Arguments for `CG_G2_GETBOLT_NOREC`.
///
...
impl OutboundSysCall for CgG2GetboltNorec {
    ...
    type Args = CgG2GetboltNorecArgs;
    type Output = qboolean;

    const IMPORT: MpCgameImport = MpCgameImport::CG_G2_GETBOLT_NOREC;
}

impl EncodeSysCall for CgG2GetboltNorec {
...
impl DecodeSysCallReturn for CgG2GetboltNorec {
