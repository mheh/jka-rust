...
impl EncodeSysCall for CgRAdddecaltoscene {
    fn encode_syscall(args: &Self::Args) -> SysCallTransport {
        SysCallTransport::new([
            ...
            abi_transport::pass_float(args.orientation()),
            abi_transport::pass_float(args.r()),
            abi_transport::pass_float(args.g()),
            abi_transport::pass_float(args.b()),
            abi_transport::pass_float(args.a()),
            args.alpha_fade() as isize,
            abi_transport::pass_float(args.radius()),
