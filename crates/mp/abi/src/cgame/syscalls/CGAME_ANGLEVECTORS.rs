...
/// Arguments for `CGAME_ANGLEVECTORS`.
///
...
///
/// Args source: `oracle/oracle/codemp/client/cl_cgame.cpp:669`
/// Output source: `oracle/oracle/codemp/client/cl_cgame.cpp:670`
/// Transport/switch source: `oracle/oracle/codemp/client/cl_cgame.cpp:668`
/// Shared trap token source: `oracle/oracle/codemp/qcommon/qcommon.h:290`
#[derive(Debug)]
pub struct CgameAnglevectorsArgs {
    angles: *const vec3_t,
    forward: *mut vec3_t,
    right: *mut vec3_t,
    up: *mut vec3_t,
...
/// `CGAME_ANGLEVECTORS` MP cgame imports syscall ABI token.
///
/// Enum value source: `oracle/oracle/codemp/cgame/cg_public.h:138`
/// Args source: `oracle/oracle/codemp/client/cl_cgame.cpp:669`
/// Output source: `oracle/oracle/codemp/client/cl_cgame.cpp:670`
/// Transport/switch source: `oracle/oracle/codemp/client/cl_cgame.cpp:668`
/// Shared trap token source: `oracle/oracle/codemp/qcommon/qcommon.h:290`
...
impl OutboundSysCall for CgameAnglevectors {
    ...
    type Args = CgameAnglevectorsArgs;
    type Output = ();

    const IMPORT: MpCgameImport = MpCgameImport::CGAME_ANGLEVECTORS;
}

impl EncodeSysCall for CgameAnglevectors {
...
impl DecodeSysCallReturn for CgameAnglevectors {
