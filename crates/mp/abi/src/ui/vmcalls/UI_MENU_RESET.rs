...
/// `UI_MENU_RESET` MP UI exports vmMain ABI token.
///
...
///
/// Source (enum): `oracle/codemp/ui/ui_public.h:250`
/// Source (args): `oracle/codemp/ui/ui_main.c:619` (no args)
/// Source (output): `oracle/codemp/ui/ui_main.c:620` (return 0)
/// Source (call site/transport): `oracle/codemp/client/cl_ui.cpp:1451`
