...
///
/// Source (enum): `oracle/codemp/ui/ui_public.h:217`
/// Source (args): `oracle/codemp/ui/ui_main.c:585` (no args)
/// Source (output): `oracle/codemp/ui/ui_main.c:580`
/// Source (call site/transport): `oracle/codemp/client/cl_ui.cpp:1484`
