...
/// `cg_main.c`'s file-scope statics (DEC-46.1), so a wave transcriber only ever
...
///
/// Source: `oracle/codemp/cgame/cg_main.c:113,115,145-149,3310-3311,3411-3414,3417,3429-3431`
