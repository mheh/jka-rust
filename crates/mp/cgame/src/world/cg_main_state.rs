...
///
/// The `strPool` buffer itself and the spawn-var scratch (`CGFOFS`-driven)
/// aren't here yet — wave 0 opens no fn that reads or writes them
/// (`CG_StrPool_Reset` only rewinds the bump offset below).
///
