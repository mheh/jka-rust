//! `CgEntsState` — `cg_ents.c`'s mutable file-scope globals as one `CgWorld`
//! sub-struct.

#![allow(non_snake_case)]

/// `cg_ents.c`'s mutable file-scope globals, grouped by owning `.c` file
...
/// `cg_ents.c`'s file-scope statics (DEC-46.1), so a wave transcriber only ever
...
///
/// Source: `oracle/codemp/cgame/cg_ents.c:2736-2738`
#[derive(Debug, Clone, Default)]
pub struct CgEntsState {}
