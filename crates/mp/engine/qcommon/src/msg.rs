...
///
/// This must be JKA's table (oracle == OpenJK == retail clients), NOT Quake
/// 3's: the Q3 table that was here previously happens to build a tree whose
/// codes agree for common symbols (all ASCII traffic worked for weeks) but
/// diverges on rare high bytes — a stock client desynced with "Illegible
/// server message" the first time a 0xB0 chat byte hit the wire.
///
/// Source: `oracle/codemp/qcommon/msg.cpp:2958-3215`
pub const MSG_H_DATA: [i32; 256] = [
    3163878, 473992, 564019, 136497, 129559, 283019, 75812, 179836, 85958, 168542, 78898, 82007,
    48613, 138741, 35482, 47433, 65214, 51636, 63741, 52823, 42464, 44495, 45347, 40260,
    59168, 44990, 52957, 42700, 42414, 36451, 45653, 44667, 125336, 38435, 53658, 42621,
    40932, 33409, 35470, 40769, 33813, 32480, 33664, 32303, 32394, 34822, 37724, 48016,
    94212, 53774, 54522, 44044, 42800, 47597, 29742, 30237, 34291, 106496, 20963, 19342,
    20603, 19568, 23013, 23939, 44995, 37128, 44264, 46636, 56400, 32746, 23458, 29702,
    25305, 20159, 19645, 20593, 21729, 19362, 24760, 22788, 25085, 21074, 97271, 22048,
    24131, 19287, 20296, 20131, 86477, 25352, 20872, 21382, 38744, 137256, 26025, 22243,
    23974, 43305, 28191, 34638, 37613, 46003, 31415, 25746, 28338, 34689, 24948, 27110,
    39950, 32793, 42639, 47883, 37439, 23875, 36092, 46471, 37392, 33063, 29604, 42140,
    61745, 45618, 51779, 49684, 57644, 65021, 67318, 88197, 258378, 76806, 72430, 64936,
    62196, 56461, 166474, 70036, 40735, 29598, 26966, 26093, 25853, 26065, 26176, 26777,
    26684, 23880, 22932, 24566, 24305, 26399, 23487, 24485, 25956, 26065, 26151, 23111,
    23900, 22128, 24096, 20863, 24298, 22572, 22364, 20813, 21414, 21570, 20799, 20971,
    22485, 20397, 88096, 17802, 20091, 84250, 21953, 21406, 23401, 19546, 19180, 18843,
    20673, 19918, 20640, 20326, 21174, 21736, 22511, 20290, 23303, 19800, 25465, 22801,
    28831, 26663, 36485, 45768, 49795, 36026, 24119, 18543, 19261, 17137, 19435, 23672,
    22988, 18107, 18734, 19847, 101897, 18405, 21260, 17818, 18971, 19317, 19112, 19395,
    20688, 18438, 18945, 29309, 19666, 18735, 87691, 18478, 22634, 20984, 20079, 18624,
    20045, 18369, 19014, 83179, 20899, 17854, 19332, 17875, 28647, 17465, 20277, 18994,
    22192, 17443, 20243, 28174, 134871, 17753, 18924, 18281, 18937, 17419, 20679, 17865,
    17984, 58615, 35506, 123499,
];
