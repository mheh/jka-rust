...
//TODO: Port Cvar_Init
// Source: oracle/oracle/codemp/qcommon/cvar.cpp (Cvar_Init); com_init step 3, common.cpp:1226
// Deliberate no-op: boot-success stub until the B1 cvar port (LIFE-Q8).
pub fn cvar_init() {}

/// Raven `Cbuf_Init` — com_init step 5.
//TODO: Port Cbuf_Init
// Source: oracle/oracle/codemp/qcommon/cmd_common.cpp (Cbuf_Init); com_init step 5, common.cpp:1233
// Deliberate no-op: boot-success stub until the B1 cmd/cbuf port (LIFE-Q8).
pub fn cbuf_init() {}

/// Raven `Cmd_Init` — com_init step 7.
//TODO: Port Cmd_Init
// Source: oracle/oracle/codemp/qcommon/cmd_common.cpp (Cmd_Init); com_init step 7, common.cpp:1242
...
// Source: oracle/oracle/codemp/qcommon/files_common.cpp (FS_InitFilesystem); com_init step 12, common.cpp:1266
