...
pub static ammoData: [ammoData_t; ammo_t::AMMO_MAX as usize] = [
	...
	ammoData_t {	// AMMO_FORCE
		//		"",				//	char	icon[32];	// Name of ammo icon file
		max: 100,
	},
	ammoData_t {	// AMMO_BLASTER
		//		"",				//	char	icon[32];	// Name of ammo icon file
		max: 300,
	},
	ammoData_t {	// AMMO_POWERCELL
		//		"",				//	char	icon[32];	// Name of ammo icon file
		max: 300,
	},
	ammoData_t {	// AMMO_METAL_BOLTS
		//		"",				//	char	icon[32];	// Name of ammo icon file
		max: 300,
	},
	ammoData_t {	// AMMO_ROCKETS
		//		"",				//	char	icon[32];	// Name of ammo icon file
		max: 25,
	},
	ammoData_t {	// AMMO_EMPLACED
		//		"",				//	char	icon[32];	// Name of ammo icon file
		max: 800,
	},
	ammoData_t {	// AMMO_THERMAL
		//		"",				//	char	icon[32];	// Name of ammo icon file
		max: 10,
	},
	ammoData_t {	// AMMO_TRIPMINE
		//		"",				//	char	icon[32];	// Name of ammo icon file
		max: 10,
	},
	ammoData_t {	// AMMO_DETPACK
		//		"",				//	char	icon[32];	// Name of ammo icon file
		max: 10,
	},
];
