...
use mp_qshared::shared::saberBlockType_t::{BLK_NO, BLK_TIGHT, BLK_WIDE};

use super::anim_number::animNumber_t::*;
use super::saber_move_data::saberMoveData_t;
use super::saber_move_name::*;
use super::saber_quadrant::saberQuadrant_t::*;
use super::set_anim::{
...
///
/// `name` points at a `'static` C-string literal (`c"..."`); the table never writes
