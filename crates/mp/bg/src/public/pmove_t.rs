...
//!
//! Type definition source: `oracle/oracle/codemp/game/bg_public.h:435-492`
...
///
/// Source: `oracle/oracle/codemp/game/bg_public.h:421`
...
pub struct pmove_t {
    /// state (in / out)
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:437`
    pub ps: *mut playerState_t,

    /// Raven: rww - shared ghoul2 stuff (not actually the same data, but hey)
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:440`
    pub ghoul2: *mut c_void,
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:441`
    pub g2Bolts_LFoot: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:442`
    pub g2Bolts_RFoot: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:443`
    pub modelScale: vec3_t,

    /// Raven: hacky bool so we know if we're dealing with a nonhumanoid (which
    /// is probably a rockettrooper).
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:446`
    pub nonHumanoid: qboolean,

    /// command (in)
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:449`
    pub cmd: usercmd_t,
    /// collide against these types of surfaces
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:450`
    pub tracemask: c_int,
    /// if set, diagnostic output will be printed
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:451`
    pub debugLevel: c_int,
    /// if the game is setup for no footsteps by the server
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:452`
    pub noFootsteps: qboolean,
    /// true if a gauntlet attack would actually hit something
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:453`
    pub gauntletHit: qboolean,

    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:455`
    pub framecount: c_int,

    /// results (out)
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:458`
    pub numtouch: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:459`
    pub touchents: [c_int; MAXTOUCH],

    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:461`
    pub useEvent: c_int,

    /// bounding box size
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:463`
    pub mins: vec3_t,
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:463`
    pub maxs: vec3_t,

    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:465`
    pub watertype: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:466`
    pub waterlevel: c_int,

    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:468`
    pub gametype: c_int,

    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:470`
    pub debugMelee: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:471`
    pub stepSlideFix: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:472`
    pub noSpecMove: c_int,

    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:474`
    pub animations: *mut animation_t,

    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:476`
    pub xyspeed: c_float,

    /// for fixed msec Pmove
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:479`
    pub pmove_fixed: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:480`
    pub pmove_msec: c_int,

    /// Raven: callbacks to test the world; these will be different functions
    /// during game and cgame.
    /// Raven field source: `oracle/oracle/codemp/game/bg_public.h:484`
    pub trace: Option<
        unsafe extern "C" fn(
            results: *mut trace_t,
            start: *const vec3_t,
