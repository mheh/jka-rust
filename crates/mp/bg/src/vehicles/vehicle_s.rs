...
//!
//! Type definition source: `oracle/codemp/game/bg_vehicles.h:477-623`
...
pub struct Vehicle_t {
    ...
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:511`
    pub m_fTimeModifier: f32,

    /// Ghoul2 Animation info.
    ///
    /// Raven: `//int m_iDriverTag;`
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:515`
    pub m_iLeftExhaustTag: c_int,
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:516`
    pub m_iRightExhaustTag: c_int,
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:517`
    pub m_iGun1Tag: c_int,
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:518`
    pub m_iGun1Bone: c_int,
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:519`
    pub m_iLeftWingBone: c_int,
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:520`
    pub m_iRightWingBone: c_int,

    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:522`
    pub m_iExhaustTag: [c_int; MAX_VEHICLE_EXHAUSTS],
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:523`
    pub m_iMuzzleTag: [c_int; MAX_VEHICLE_MUZZLES],
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:524`
    pub m_iDroidUnitTag: c_int,
    /// Raven: Where to put the view origin of the gunner (index)
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:525`
    pub m_iGunnerViewTag: [c_int; MAX_VEHICLE_TURRETS],

    /// Raven: this stuff is a little bit different from SP, because I am lazy
    /// -rww
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:528`
    pub m_iMuzzleTime: [c_int; MAX_VEHICLE_MUZZLES],
    /// These are updated every frame and represent the current position for
    /// the specific muzzle.
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:530`
    ...
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:534`
    pub m_iMuzzleWait: [c_int; MAX_VEHICLE_MUZZLES],

    /// The user commands structure.
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:537`
    pub m_ucmd: usercmd_t,

    /// The direction an entity will eject from the vehicle towards.
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:540`
    pub m_EjectDir: c_int,

    /// Flags that describe the vehicles behavior.
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:543`
    pub m_ulFlags: u64,
    ...
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:548`
    ...
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:552`
    ...
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:557`
    pub m_fStrafeTime: c_int,

    /// Previous angles of this vehicle.
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:560`
    pub m_vPrevOrientation: vec3_t,

    /// Previous viewangles of the rider
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:563`
    ...
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:566`
    pub m_vAngularVelocity: f32,

    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:568`
    ...
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:571`
    pub m_iArmor: c_int,
    /// Raven: energy shielding - STAT_ARMOR on NPC
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:572`
    pub m_iShields: c_int,

    /// Raven: mp-specific
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:575`
    pub m_iHitDebounce: c_int,

    /// Timer for all cgame-FX...? ex: exhaust?
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:578`
    pub m_iLastFXTime: c_int,

    /// When to die.
    /// Raven field source: `oracle/codemp/game/bg_vehicles.h:581`
