...
//!
//! Type definition source: `oracle/oracle/codemp/game/g_public.h:679-715`
...
pub struct sharedEntity_t {
    ...
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:680`
    pub s: entityState_t,
    ...
    /// first.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:681-683`
    pub playerState: *mut playerState_t,
    //TODO: Port Vehicle_t
    // Source: oracle/oracle/codemp/game/bg_vehicles.h:477 (used *mut only via g_public.h:684)
    /// Placeholder for `Vehicle_t *m_pVehicle` until `Vehicle_t` is ported.
    /// Vehicle data.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:684`
    pub m_pVehicle: *mut c_void,
    /// G2 instance.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:685`
    pub ghoul2: *mut c_void,
    /// Index locally (game/cgame) to anim data for this skel.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:686`
    pub localAnimIndex: c_int,
    /// Needed for g2 collision.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:687`
    pub modelScale: vec3_t,
    /// From here up must also be unified with bgEntity/centity.
    ///
    /// Shared by both the server system and game.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:691`
    pub r: entityShared_t,
    /// Script/ICARUS-related field.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:694`
    pub taskID: [c_int; NUM_TIDS],
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:695`
    pub parms: *mut parms_t,
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:696`
    pub behaviorSet: [*mut c_char; NUM_BSETS],
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:697`
    pub script_targetname: *mut c_char,
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:698`
    pub delayScriptTime: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:699`
    pub fullName: *mut c_char,
    /// rww - targetname and classname are now shared as well. ICARUS needs
    /// access to them.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:702`
    pub targetname: *mut c_char,
    /// Set in QuakeEd.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:703`
    ...
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:706`
    pub waypoint: c_int,
    /// To make sure you don't double-back.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:707`
    pub lastWaypoint: c_int,
    /// ALWAYS valid - used for tracking someone you lost.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:708`
    ...
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:709`
    pub noWaypointTime: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:710`
    pub combatPoint: c_int,
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:711`
    pub failedWaypoints: [c_int; MAX_FAILED_NODES],
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:712`
    pub failedWaypointCheckTime: c_int,
    /// rww - npc's need to know when they're getting roff'd.
    /// Raven field source: `oracle/oracle/codemp/game/g_public.h:714`
