...
/// `MAX_MESSAGE_SIZE`.
///
/// Type definition source: `oracle/oracle/codemp/game/be_ai_chat.h:16`
pub const MAX_MESSAGE_SIZE: usize = 256;

/// `MAX_MATCHVARIABLES`.
///
/// Type definition source: `oracle/oracle/codemp/game/be_ai_chat.h:18`
pub const MAX_MATCHVARIABLES: usize = 8;

/// Raven `bot_match_t` — a matched bot chat message, with type/subtype and
/// extracted variables.
///
/// Type definition source: `oracle/oracle/codemp/game/be_ai_chat.h:45-51`
#[repr(C)]
