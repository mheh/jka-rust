...
pub struct botlib_import_t {
	...
	pub FS_Seek: Option<unsafe extern "C" fn(f: fileHandle_t, offset: c_long, origin: c_int) -> c_int>,
	/// debug visualisation stuff
	pub DebugLineCreate: Option<unsafe extern "C" fn() -> c_int>,
	pub DebugLineDelete: Option<unsafe extern "C" fn(line: c_int)>,
	pub DebugLineShow: Option<unsafe extern "C" fn(line: c_int, start: *mut vec3_t, end: *mut vec3_t, color: c_int)>,
