...
pub use native_math::qmath::{
    ...
    Q_random, RadiusFromBounds, RotateAroundDirection, RotatePointAroundVector,
    TransformAndTranslatePoint, TransformPoint, VectorBetweenVectors, VectorClear, VectorCompare,
    VectorCompare2, VectorInverse, VectorLength, VectorLengthSquared, VectorNPos, VectorNormalize,
