...
/// up at the frame boundary (A9), the render-thread-only GPU state, and this
/// frame's scratch. Replaces the oracle's `tr`/`backEnd`/`glState` globals as
/// a single threaded object (porting-rules §B4/§B6).
