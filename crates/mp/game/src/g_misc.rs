...
use crate::g_utils::{
    G_AddEvent, G_EffectIndex, G_FreeEntity, G_KillBox, G_ModelIndex, G_PickTarget, G_ScreenShake,
    G_SetMovedir, G_SetOrigin, G_SoundIndex, G_TempEntity, G_UseTargets,
};
...
// PORT-ESCALATION(raw-ptr-skeleton-no-world-handle): reads `g_MaxHolocronCarry`
...
pub fn health_power_converter_use(
    ...
    todo!("Port health_power_converter_use — parked: raw-ptr-skeleton-no-world-handle")
}
