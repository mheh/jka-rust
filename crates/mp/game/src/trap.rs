...
pub fn Argc(
    engine: &Engine,
    args: <GArgc as OutboundSysCall>::Args,
) -> <GArgc as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GArgc>>::execute(engine, args)
}
...
pub fn Argv(
    engine: &Engine,
    args: <GArgv as OutboundSysCall>::Args,
) -> <GArgv as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GArgv>>::execute(engine, args)
}
...
pub fn Cvar_Register(
    engine: &Engine,
    args: <GCvarRegister as OutboundSysCall>::Args,
) -> <GCvarRegister as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GCvarRegister>>::execute(engine, args)
}
...
pub fn Cvar_Set(
    engine: &Engine,
    args: <GCvarSet as OutboundSysCall>::Args,
) -> <GCvarSet as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GCvarSet>>::execute(engine, args)
}
...
pub fn Cvar_Update(
    engine: &Engine,
    args: <GCvarUpdate as OutboundSysCall>::Args,
) -> <GCvarUpdate as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GCvarUpdate>>::execute(engine, args)
}
...
pub fn Cvar_VariableIntegerValue(
    engine: &Engine,
    args: <GCvarVariableIntegerValue as OutboundSysCall>::Args,
) -> <GCvarVariableIntegerValue as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GCvarVariableIntegerValue>>::execute(engine, args)
}
...
pub fn Cvar_VariableStringBuffer(
    engine: &Engine,
    args: <GCvarVariableStringBuffer as OutboundSysCall>::Args,
) -> <GCvarVariableStringBuffer as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GCvarVariableStringBuffer>>::execute(engine, args)
}
...
pub fn DropClient(
    engine: &Engine,
    args: <GDropClient as OutboundSysCall>::Args,
) -> <GDropClient as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GDropClient>>::execute(engine, args)
}
...
pub fn Error(
    engine: &Engine,
    args: <GError as OutboundSysCall>::Args,
) -> <GError as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GError>>::execute(engine, args)
}

/// Raven `trap_FS_FCloseFile` (`g_syscalls.c:97-99`) — `G_FS_FCLOSE_FILE`.
/// C: `void trap_FS_FCloseFile(fileHandle_t f)`
pub fn FS_FCloseFile(
    engine: &Engine,
    args: <GFsFcloseFile as OutboundSysCall>::Args,
) -> <GFsFcloseFile as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GFsFcloseFile>>::execute(engine, args)
}
...
pub fn FS_FOpenFile(
    engine: &Engine,
    args: <GFsFopenFile as OutboundSysCall>::Args,
) -> <GFsFopenFile as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
...
pub fn FS_GetFileList(
    engine: &Engine,
    args: <GFsGetfilelist as OutboundSysCall>::Args,
) -> <GFsGetfilelist as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GFsGetfilelist>>::execute(engine, args)
}
...
pub fn FS_Read(
    engine: &Engine,
    args: <GFsRead as OutboundSysCall>::Args,
) -> <GFsRead as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GFsRead>>::execute(engine, args)
}
...
pub fn FS_Write(
    engine: &Engine,
    args: <GFsWrite as OutboundSysCall>::Args,
) -> <GFsWrite as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GFsWrite>>::execute(engine, args)
}
...
pub fn GetConfigstring(
    engine: &Engine,
    args: <GGetConfigstring as OutboundSysCall>::Args,
) -> <GGetConfigstring as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GGetConfigstring>>::execute(engine, args)
}
...
pub fn GetEntityToken(
    engine: &Engine,
    args: <GGetEntityToken as OutboundSysCall>::Args,
) -> <GGetEntityToken as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GGetEntityToken>>::execute(engine, args)
}
...
pub fn GetServerinfo(
    engine: &Engine,
    args: <GGetServerinfo as OutboundSysCall>::Args,
) -> <GGetServerinfo as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GGetServerinfo>>::execute(engine, args)
}
...
pub fn GetUserinfo(
    engine: &Engine,
    args: <GGetUserinfo as OutboundSysCall>::Args,
) -> <GGetUserinfo as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GGetUserinfo>>::execute(engine, args)
}
...
/// Preserved verbatim from the slice-0 live `trap.rs` (not clobbered by the
/// generated wrapper merge).
pub fn Printf(
    engine: &Engine,
...
pub fn SendConsoleCommand(
    engine: &Engine,
    args: <GSendConsoleCommand as OutboundSysCall>::Args,
) -> <GSendConsoleCommand as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GSendConsoleCommand>>::execute(engine, args)
}
...
pub fn SendServerCommand(
    engine: &Engine,
    args: <GSendServerCommand as OutboundSysCall>::Args,
) -> <GSendServerCommand as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GSendServerCommand>>::execute(engine, args)
}
...
pub fn SetConfigstring(
    engine: &Engine,
    args: <GSetConfigstring as OutboundSysCall>::Args,
) -> <GSetConfigstring as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GSetConfigstring>>::execute(engine, args)
}
...
pub fn SetUserinfo(
    engine: &Engine,
    args: <GSetUserinfo as OutboundSysCall>::Args,
) -> <GSetUserinfo as OutboundSysCall>::Output {
    // UFCS spelling of the frozen `engine.execute(args)` — the bare
    // method call cannot infer `C` from `Args` alone (SEAM-D13).
    <Engine as Execute<GSetUserinfo>>::execute(engine, args)
}
