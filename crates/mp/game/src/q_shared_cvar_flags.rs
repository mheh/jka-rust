...
///
/// Source: `oracle/codemp/game/q_shared.h:1790`
pub const CVAR_LATCH: c_int = 0x0000_0020;

/// Raven `CVAR_ROM`: display only, cannot be set by user at all (can be set by code).
///
/// Source: `oracle/codemp/game/q_shared.h:1795`
pub const CVAR_ROM: c_int = 0x0000_0040;

/// Raven `CVAR_USER_CREATED`: created by a set command.
///
/// Source: `oracle/codemp/game/q_shared.h:1796`
pub const CVAR_USER_CREATED: c_int = 0x0000_0080;

/// Raven `CVAR_TEMP`: can be set even when cheats are disabled, but is not archived.
///
/// Source: `oracle/codemp/game/q_shared.h:1797`
pub const CVAR_TEMP: c_int = 0x0000_0100;

/// Raven `CVAR_CHEAT`: can not be changed if cheats are disabled.
///
/// Source: `oracle/codemp/game/q_shared.h:1798`
