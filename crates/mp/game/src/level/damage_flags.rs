...
//!
//! This is the game-tier home for these flags.
//! `DAMAGE_NO_ARMOR` is the one flag that bg consumes (`bg_slidemove`), and `mp_bg::public::damage_flags` mirrors it as a bit-identical twin.
//! Keep the value in sync between the two.
//!
