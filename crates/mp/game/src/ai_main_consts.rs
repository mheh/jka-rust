...
///
/// Source: `oracle/oracle/codemp/game/ai_main.h:44`
...
///
/// Source: `oracle/oracle/codemp/game/ai_main.h:53`
pub const MAX_CHICKENWUSS_TIME: c_int = 10000;

/// Raven `BOT_RUN_HEALTH`.
///
/// Source: `oracle/oracle/codemp/game/ai_main.h:55`
...
/// visible.
///
/// Source: `oracle/oracle/codemp/game/ai_main.h:57`
pub const ENEMY_FORGET_MS: c_int = 10000;

/// Raven `BASE_GUARD_DISTANCE` — guarding the flag.
///
/// Source: `oracle/oracle/codemp/game/ai_main.h:73`
pub const BASE_GUARD_DISTANCE: c_int = 256;

/// Raven `BASE_GETENEMYFLAG_DISTANCE` — waiting around to get the enemy's
/// flag.
///
/// Source: `oracle/oracle/codemp/game/ai_main.h:75`
pub const BASE_GETENEMYFLAG_DISTANCE: c_int = 256;

/// Raven botlib.h print-level `#define`s (not an enum), so §C8 makes them
/// `const`s directly.
///
/// Source: `oracle/oracle/codemp/game/botlib.h:39-43`
pub const PRT_MESSAGE: c_int = 1;
/// Raven `PRT_WARNING`. Source: `oracle/oracle/codemp/game/botlib.h:40`
pub const PRT_WARNING: c_int = 2;
/// Raven `PRT_ERROR`. Source: `oracle/oracle/codemp/game/botlib.h:41`
pub const PRT_ERROR: c_int = 3;
/// Raven `PRT_FATAL`. Source: `oracle/oracle/codemp/game/botlib.h:42`
pub const PRT_FATAL: c_int = 4;
/// Raven `PRT_EXIT`. Source: `oracle/oracle/codemp/game/botlib.h:43`
...
///
/// Source: `oracle/oracle/codemp/game/ai_main.c:1551-1552`
pub const STRAFEAROUND_RIGHT: c_int = 1;
/// Raven `STRAFEAROUND_LEFT`. Source: `oracle/oracle/codemp/game/ai_main.c:1552`
pub const STRAFEAROUND_LEFT: c_int = 2;

/// Raven `ctfStateDescriptions` — CTF state description strings, indexed by
/// `ctfState_t`.
///
/// Source: `oracle/oracle/codemp/game/ai_main.c:106-113`
...
///
/// Source: `oracle/oracle/codemp/game/ai_main.c:115-119`
...
///
/// Source: `oracle/oracle/codemp/game/ai_main.c:121-126`
