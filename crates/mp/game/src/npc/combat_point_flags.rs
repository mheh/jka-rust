...
///
/// Source: `oracle/oracle/codemp/game/b_local.h:268`
pub const CPF_LEAN: c_int = 0x00000010;
/// Raven `CPF_SNIPE` — `combatPoint_t::flags` bit.
///
/// Source: `oracle/oracle/codemp/game/b_local.h:269`
