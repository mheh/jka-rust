...
use sp_qshared::shared::{cplane_t, qboolean, vec3_t};
...
const _: () = assert!(core::mem::size_of::<viewParms_t>() == 512);
const _: () = assert!(core::mem::offset_of!(viewParms_t, or) == 0);
...
const _: () = assert!(core::mem::offset_of!(viewParms_t, visBounds) == 484);
const _: () = assert!(core::mem::offset_of!(viewParms_t, zFar) == 508);
