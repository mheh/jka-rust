...
///
/// Type definition source: `oracle/oracle/code/ui/ui_shared.h:316-340`
#[repr(C)]
...
pub struct windowDef_t {
    ...
    pub nextTime: c_int,
    /// time when delay expires
    pub delayTime: c_int,
    /// points into another script's text while delaying
    pub delayedScript: *const c_char,
    /// text color
...
const _: () = assert!(core::mem::size_of::<windowDef_t>() == 208);
#[cfg(target_pointer_width = "64")]
...
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(windowDef_t, delayTime) == 124);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(windowDef_t, delayedScript) == 128);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(windowDef_t, foreColor) == 136);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(windowDef_t, backColor) == 152);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(windowDef_t, borderColor) == 168);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(windowDef_t, outlineColor) == 184);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(windowDef_t, background) == 200);
