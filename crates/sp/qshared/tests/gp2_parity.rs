//! Differential parity: the Rust SP GP2 port must reproduce, byte for byte,
//! the dumps produced by the UNMODIFIED Raven C++ GP2 compiled by
//! `tools/gp2-oracle/run.sh` (goldens under `tools/gp2-oracle/golden/`).
//!
//! The dump format mirrors `tools/gp2-oracle/main.cpp` exactly.

use sp_qshared::common::sp::game::gp2::generic_parser2::GenericParser2;
use sp_qshared::common::sp::game::gp2::gp_group::GpGroup;
