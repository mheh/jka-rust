...
use super::turret_stats_t::turretStats_t;
use super::veh_weapon_stats_t::vehWeaponStats_t;
use super::vehicle_t::Vehicle_t;
...
const _: () = assert!(core::mem::size_of::<vehicleInfo_t>() == 904);
#[cfg(target_pointer_width = "64")]
...
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, droidNPC) == 208);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundOn) == 216);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundOff) == 220);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundLoop) == 224);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundTakeOff) == 228);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundEngineStart) == 232);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundSpin) == 236);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundTurbo) == 240);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundHyper) == 244);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundLand) == 248);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundFlyBy) == 252);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundFlyBy2) == 256);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundShift1) == 260);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundShift2) == 264);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundShift3) == 268);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, soundShift4) == 272);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iExhaustFX) == 276);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iTurboFX) == 280);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iTurboStartFX) == 284);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iTrailFX) == 288);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iImpactFX) == 292);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iExplodeFX) == 296);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iWakeFX) == 300);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iDmgFX) == 304);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iArmorLowFX) == 308);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, iArmorGoneFX) == 312);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, weapon) == 316);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, weapMuzzle) == 372);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, turret) == 416);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, landingHeight) == 608);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, gravity) == 612);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, hoverHeight) == 616);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, hoverStrength) == 620);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, waterProof) == 624);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, bouyancy) == 628);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, fuelMax) == 632);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, fuelRate) == 636);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, turboDuration) == 640);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, turboRecharge) == 644);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, visibility) == 648);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, loudness) == 652);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, explosionRadius) == 656);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, explosionDamage) == 660);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, maxPassengers) == 664);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, hideRider) == 668);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, killRiderOnDeath) == 672);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, flammable) == 676);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, explosionDelay) == 680);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, cameraOverride) == 684);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, cameraRange) == 688);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, cameraVertOffset) == 692);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, cameraHorzOffset) == 696);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, cameraPitchOffset) == 700);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, cameraFOV) == 704);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, cameraAlpha) == 708);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, cameraPitchDependantVertOffset) == 712);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, modelIndex) == 716);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, AnimateVehicle) == 720);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, AnimateRiders) == 728);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, ValidateBoard) == 736);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, SetParent) == 744);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, SetPilot) == 752);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, AddPassenger) == 760);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, Animate) == 768);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, Board) == 776);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, Eject) == 784);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, EjectAll) == 792);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, StartDeathDelay) == 800);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, DeathUpdate) == 808);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, RegisterAssets) == 816);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, Initialize) == 824);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, Update) == 832);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, UpdateRider) == 840);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, ProcessMoveCommands) == 848);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, ProcessOrientCommands) == 856);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, AttachRiders) == 864);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, Ghost) == 872);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, UnGhost) == 880);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, GetPilot) == 888);
#[cfg(target_pointer_width = "64")]
const _: () = assert!(core::mem::offset_of!(vehicleInfo_t, Inhabited) == 896);
