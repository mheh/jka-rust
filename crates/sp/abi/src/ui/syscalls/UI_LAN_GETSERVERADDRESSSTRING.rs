...
impl OutboundSysCall for UiLanGetserveraddressstring {
    ...
    /// Transport source: `oracle/oracle/codemp/client/cl_ui.cpp:1088-1090`
    /// SP transport path in `oracle/oracle/code/client/cl_ui.cpp` has no `UI_LAN_GETSERVERADDRESSSTRING` case.
    ///
    /// Args source: `oracle/oracle/codemp/client/cl_ui.cpp:1088-1090`
    /// Output source: `oracle/oracle/codemp/client/cl_ui.cpp:1090`
