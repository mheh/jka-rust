...
impl OutboundSysCall for UiLanGetserverping {
    ...
    /// Transport source: `oracle/codemp/client/cl_ui.cpp:1096-1097`
    /// SP transport path in `oracle/code/client/cl_ui.cpp` has no `UI_LAN_GETSERVERPING` case.
    ///
    /// Args source: `oracle/codemp/client/cl_ui.cpp:1096-1097`
    /// Output source: `oracle/codemp/client/cl_ui.cpp:1096-1097`
