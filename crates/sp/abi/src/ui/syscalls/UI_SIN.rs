...
impl OutboundSysCall for UiSin {
    ...
    /// Args source: no direct `UI_SIN` case in `oracle/code/client/cl_ui.cpp`.
    /// Fallback source (same Raven ABI profile): `oracle/codemp/client/cl_ui.cpp:826-828`.
    ...
    type Args = f32;
    /// Output source: `oracle/codemp/client/cl_ui.cpp:827`
