...
///
/// Enum source: `oracle/code/ui/ui_public.h:166`
/// Args source: `oracle/code/ui/ui_public.h:37`
/// Output source:
/// - `oracle/code/ui/ui_public.h:37` declares `int` return
/// - `oracle/codemp/client/cl_ui.cpp:917-919` returns `0` (unit)
/// Transport/switch source: `oracle/codemp/client/cl_ui.cpp:917-919`
/// TODO: SP `oracle/code/client/cl_ui.cpp` has no `UI_FS_READ` case in this branch.
