...
impl OutboundSysCall for UiRRegisterfont {
    ...
    /// Args source: `oracle/code/ui/ui_public.h:50` and `oracle/codemp/client/cl_ui.cpp:1132`.
    type Args = *const c_char;
    /// Output source: `oracle/code/ui/ui_public.h:50` and `oracle/codemp/client/cl_ui.cpp:1132`.
