...
/// `UI_PC_SOURCE_FILE_AND_LINE` SP UI imports syscall ABI token.
///
...
impl OutboundSysCall for UiPcSourceFileAndLine {
    ...
    /// and has no active switch case for it (`oracle/code/client/cl_ui.cpp:352-353`, `443-447`).
    /// Fallback transport shape from MP parity:
    /// `oracle/codemp/ui/ui_syscalls.c:378-379` and
    /// `oracle/codemp/client/cl_ui.cpp:1165-1166`.
    ///
    ...
    /// `oracle/codemp/ui/ui_syscalls.c:378-379`.
    type Output = c_int;
