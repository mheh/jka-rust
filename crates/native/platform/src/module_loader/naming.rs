...
///
/// Source: `oracle/oracle/codemp/win32/win_main.cpp:826` ("x86.dll");
/// `oracle/oracle/codemp/unix/unix_main.c:346` ("i386.so").
pub struct ModuleNaming {
    ...
    // Source: oracle/oracle/codemp/win32/win_main.cpp:826
