...
impl EncodeSysCall for CgRAdddecaltoscene {
    fn encode_syscall(args: &Self::Args) -> SysCallTransport {
        SysCallTransport::new([
            ...
            crate::abi::pass_float(args.orientation()),
            crate::abi::pass_float(args.r()),
            crate::abi::pass_float(args.g()),
            crate::abi::pass_float(args.b()),
            crate::abi::pass_float(args.a()),
            args.alpha_fade() as isize,
            crate::abi::pass_float(args.radius()),
