...
impl GG2TraceArgs {
    pub fn new(
        ...
        Self { results, start, mins, maxs, end, pass_entity_num, contentmask, g2_trace_type, trace_lod }
    }
    ...
    pub fn g2_trace_type(&self) -> c_int { self.g2_trace_type }
    pub fn trace_lod(&self) -> c_int { self.trace_lod }
}
