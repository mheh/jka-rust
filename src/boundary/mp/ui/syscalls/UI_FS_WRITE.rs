...
/// Arguments for the `UI_FS_WRITE` outbound cgame-to-engine syscall.
///
...
///
/// Sources:
/// - args: `oracle/oracle/codemp/ui/ui_syscalls.c:91-92`
/// - transport: `oracle/oracle/codemp/client/cl_ui.cpp:742-743`
#[derive(Debug)]
...
/// `UI_FS_WRITE` MP cgame imports syscall boundary token.
///
...
impl OutboundSysCall for CgFsWrite {
    ...
    ///
    /// Sources:
    /// - wrapper output: `oracle/oracle/codemp/ui/ui_syscalls.c:91-92`
    /// - switch output: `oracle/oracle/codemp/client/cl_ui.cpp:742-744`
    type Output = ();
