...
/// `UiG2_HASGHOUL2MODELONINDEX` outbound game-to-engine syscall.
///
...
/// `UiG2_HASGHOUL2MODELONINDEX` MP game imports syscall boundary token.
///
...
impl OutboundSysCall for GG2Hasghoul2Modelonindex {
    ...
    const IMPORT: GameImport = GameImport::UiG2_HASGHOUL2MODELONINDEX;
}
