...
/// `UiG2_SETNEWORIGIN` outbound game-to-engine syscall.
///
...
/// `UiG2_SETNEWORIGIN` MP game imports syscall boundary token.
///
...
impl OutboundSysCall for GG2Setneworigin {
    ...
    const IMPORT: GameImport = GameImport::UiG2_SETNEWORIGIN;
}
